	...
	<body>
		<header>
			...
			<ul class="menu">
				...
				<li><a href="#" onclick="toggleMenu();"><font color="black">Ticket List</font></a></li>
		...
		<div class="contactUs">
			...
			<div class="box">
				...
				<div class="contact form">
	                ...
	                <table bgcolor="black" align="center">
	                    ...
	                    <tr>
	                        ...
	                        <td bgcolor="grey" align="center" width="30%">Ticket Type</td>
	                        <td bgcolor="grey" align="center" width="25%">Ticket Price</td>
	                    ...
	                    <?php
	                        ...
	                        if ($result = mysqli_query($dbc, $sql)) 
	                        {
							    ...
							    // Display result
							    printf("Total Tickets In Database : %d\n", $rowcount);
							}
	                        ...
	                        while($list = mysqli_fetch_assoc($result))
	                        {
	                            ...
	                            <td class="font">'.$list['Ticket_Type'].'</td>
	                            <td class="font" align="center">'.$list['Ticket_Price'].'</td>
	                            <td colspan="2">
	                                <a class="btn1" href="FormUpdateTicket.php?ID='.$list['Ticket_ID'].'">Update</a>
	                                <a class="btn2" href="FormDeleteTicket.php?ID='.$list['Ticket_ID'].'">Delete</a>
	                            </td>';
	                        }
	                    ?>
	        	...
	        	<br><div class="row100">
	        			<!-- <a href="FormBookingList.php" class="clear" value="Reserve List" title="Reserve List">Reservation List</a> -->
